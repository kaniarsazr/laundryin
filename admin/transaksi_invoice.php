...
<body>
    ...
    <div class="container">
        ...
        $id = $_GET['id'];
        //mengambil data pelanggan yang ber-id diatas dari table pelanggan
        $transaksi = mysqli_query($koneksi, "SELECT * FROM transaksi,pelanggan 
        WHERE transaksi_id='$id' and transaksi_pelanggan=pelanggan_id");
        ...
        while($t=mysqli_fetch_array($transaksi)){
            ...
            <table class="table">
                ...
                <tr>
                    <th>Harga</th>
                    <th>:</th>
                    <td><?php echo "Rp. ".number_format($t['transaksi_harga'])." ,-";
                    ?></td>
                </tr>
            </table>
            ...
            <table class="table table-bordered table-striped">
                ...
                <?php }?> <!--End of while($p=mysqli_fetch_array($pakaian)) -->
        ...
        <?php }?> <!--End of while($t=mysqli_fetch_array($transaksi))-->
