...
<div class="container">
	<div class="alert alert-info text-center">
		...
		Di Sistem Informasi Ahmad Irfanda</h4>
	</div>
					...
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h1>
								...
								<?php 
								$pelanggan = mysqli_query($koneksi, "SELECT * 
								FROM pelanggan");
						...
						<div class="panel-heading">
							<h1>
								...
								<span class="pull-right">
									...
									<?php
									$proses= mysqli_query($koneksi, "SELECT * FROM 
									transaksi WHERE transaksi_status='0'");
						...
						<div class="panel panel-heading">
							<h1>
								...
								<span class="pull-right">
									...
									<?php
									$proses = mysqli_query($koneksi, "SELECT * FROM 
									transaksi WHERE transaksi_status='1'");
									echo mysqli_num_rows($proses);
									?>
								</span>
							</h1>
					...
					<div class="panel panel-success">
						<div class="panel-heading">
							<h1>
								...
								<?php 
								$proses = mysqli_query($koneksi, "SELECT * FROM 
								transaksi WHERE transaksi_status='2'");
								echo mysqli_num_rows($proses);
								?>
								</span>
							</h1>
	...
	<div class="panel">
		...
		<div class="panel-body">
			<table class="table table-bordered table-striped">
				...
				pelanggan,transaksi WHERE transaksi_pelanggan=
				pelanggan_id order by transaksi_id desc limit 7");
				$no = 1;
